...
import assignment_mazeworld.PacmanMazeProblem.PacmanMazeNode;

public class PacmanMazeDriver extends Application {
	...
	private void runSearches() {
		...
		PacmanMazeProblem mazeProblem = new PacmanMazeProblem(maze, sx, sy, gx,
				gy);
